    ...
    for aa=1:length(unique(stim.isiseq))
      for bb=1:length(unique(stim.durseq))
        try
          ...
          percoroutnum(aa,:,bb)=[length(find(~isnan(resp.motdirkeycode) & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(~isnan(resp.motdirkeycode) & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(~isnan(resp.motdirkeycode) & ~stim.av.congseq & ~stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))];
          %           percorout(:,aa,bb)=[length(find(resp.cormotdir==resp.motdirkeycode & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(~isnan(resp.motdirkeycode) & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(resp.cormotdir==resp.motdirkeycode & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(~isnan(resp.motdirkeycode) & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(resp.cormotdir==resp.motdirkeycode & ~stim.av.congseq & ~stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(~isnan(resp.motdirkeycode) & ~stim.av.congseq & ~stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))];
        catch
    ...
    if setup.av.askfmdcs==1 || setup.av.askfmdcs==2
      ...
      for aa=1:length(unique(stim.isiseq))
        for bb=1:length(unique(stim.durseq))
          ...
          comsrcisidur_denom(aa,:,bb)=[length(find(~isnan(resp.comsrckeycode) & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))         length(find(~isnan(resp.comsrckeycode)& ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   ];
        end
      end
      ...
      for aa=1:length(unique(stim.isiseq))
        for bb=1:length(unique(stim.durseq))
          ...
          comsrcMDisidur_denom(aa,:,bb)=[length(find(~isnan(resp.comsrckeycode) & stim.av.congseq & resp.cormotdir==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(~isnan(resp.comsrckeycode) & stim.av.congseq & resp.cormotdir~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(~isnan(resp.comsrckeycode)& ~stim.av.congseq & resp.cormotdir==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))      length(find(~isnan(resp.comsrckeycode)& ~stim.av.congseq & resp.cormotdir~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))];
        end
      end
      ...
      for aa=1:length(unique(stim.isiseq))
        for bb=1:length(unique(stim.durseq))
          try
            ...
            percorcomsrc_num(aa,:,bb)=[length(find(~isnan(resp.motdirkeycode) & resp.comsrckeycode==resp.comsrckey(1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  length(find(~isnan(resp.motdirkeycode) & resp.comsrckeycode==resp.comsrckey(2) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb)) ];
            %           percorout(:,aa,bb)=[length(find(resp.cormotdir==resp.motdirkeycode & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(~isnan(resp.motdirkeycode) & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(resp.cormotdir==resp.motdirkeycode & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(~isnan(resp.motdirkeycode) & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(resp.cormotdir==resp.motdirkeycode & ~stim.av.congseq & ~stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(~isnan(resp.motdirkeycode) & ~stim.av.congseq & ~stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))];
          catch
            error('reminder to clear before reload')
          end
      ...
      for aa=1:length(unique(stim.isiseq))
        for bb=1:length(unique(stim.durseq))
          try
            ...
            percorcorcomsrc_num(aa,:,bb)=[length(find(~isnan(resp.motdirkeycode) & resp.comsrckeycode==resp.corcong & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(~isnan(resp.motdirkeycode) & ~(resp.comsrckeycode==resp.corcong) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb)) ];
            %           percorout(:,aa,bb)=[length(find(resp.cormotdir==resp.motdirkeycode & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(~isnan(resp.motdirkeycode) & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(resp.cormotdir==resp.motdirkeycode & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(~isnan(resp.motdirkeycode) & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(resp.cormotdir==resp.motdirkeycode & ~stim.av.congseq & ~stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(~isnan(resp.motdirkeycode) & ~stim.av.congseq & ~stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))];
          catch
            error('reminder to clear before reload')
          end
      ...
      for aa=1:length(unique(stim.isiseq))
        for bb=1:length(unique(stim.durseq))
          try
            ...
            percorcomsrccong_denom(aa,:,bb)=[length(find(~isnan(resp.motdirkeycode) & resp.comsrckeycode==resp.corcong & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(~isnan(resp.motdirkeycode) & resp.comsrckeycode==resp.corcong & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(~isnan(resp.motdirkeycode) & ~(resp.comsrckeycode==resp.corcong) & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(~isnan(resp.motdirkeycode) & ~(resp.comsrckeycode==resp.corcong) & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb)) ];
          catch
            error('reminder to clear before reload')
          end
        end
          ...
          for cc=2
            for aa=1:length(unique(stim.isiseq))
              for bb=1:length(unique(stim.durseq))
                ...
                permotperisidur_num(aa,:,bb)=[length(find(~isnan(resp.motdirkeycode) & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  length(find(~isnan(resp.motdirkeycode) & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(~isnan(resp.motdirkeycode) & ~stim.av.congseq & ~stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))];
              end
            end
          end
      ...
      case 'cued'
        ...
        try
          for cc=unique(stim.av.cueseq)
            ...
            percorcomsrccong_percue_denom(cc,:)=[length(find(~isnan(resp.motdirkeycode) & resp.comsrckeycode==resp.corcong & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))   length(find(~isnan(resp.motdirkeycode) & resp.comsrckeycode==resp.corcong & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))   length(find(~isnan(resp.motdirkeycode) & ~(resp.comsrckeycode==resp.corcong) & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))    length(find(~isnan(resp.motdirkeycode) & ~(resp.comsrckeycode==resp.corcong) & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc)) ];
          end
        catch
          error('reminder to clear before reload')
        end
        ...
        try
          for cc=unique(stim.av.cueseq)
            ...
            comsrcMDisidur_percue_denom(cc,:)=[length(find(~isnan(resp.comsrckeycode) & stim.av.congseq & resp.cormotdir==resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))         length(find(~isnan(resp.comsrckeycode) & stim.av.congseq & resp.cormotdir~=resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))          length(find(~isnan(resp.comsrckeycode)& ~stim.av.congseq & resp.cormotdir==resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))               length(find(~isnan(resp.comsrckeycode)& ~stim.av.congseq & resp.cormotdir~=resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))];
          end
        catch
          error('reminder to clear before reload')
        end
