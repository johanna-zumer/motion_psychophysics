...
switch stim.block
  case 'av'
    ...
    if isfield(setup,'respcertMD') && setup.respcertMD==1
      [length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.congseq & stim.av.vtrialseq))  /length(find(trialuse & stim.av.congseq & stim.av.vtrialseq))   length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & ~stim.av.congseq & stim.av.vtrialseq))  /length(find(trialuse & ~stim.av.congseq & stim.av.vtrialseq))  length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & ~stim.av.congseq & ~stim.av.vtrialseq))  /length(find(trialuse & ~stim.av.congseq & ~stim.av.vtrialseq))]
      motdir_certuncert(1,:)=[length(find(resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.congseq & stim.av.vtrialseq))  /length(find(trialuse & stim.av.congseq & stim.av.vtrialseq))   length(find(resp.cormotdir(:,1)'==resp.motdirkeycode & ~stim.av.congseq & stim.av.vtrialseq))  /length(find(trialuse & ~stim.av.congseq & stim.av.vtrialseq))  length(find(resp.cormotdir(:,1)'==resp.motdirkeycode & ~stim.av.congseq & ~stim.av.vtrialseq))  /length(find(trialuse & ~stim.av.congseq & ~stim.av.vtrialseq))];
      motdir_certuncert(2,:)=[length(find(resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.congseq & stim.av.vtrialseq))  /length(find(trialuse & stim.av.congseq & stim.av.vtrialseq))   length(find(resp.cormotdir(:,2)'==resp.motdirkeycode & ~stim.av.congseq & stim.av.vtrialseq))  /length(find(trialuse & ~stim.av.congseq & stim.av.vtrialseq))  length(find(resp.cormotdir(:,2)'==resp.motdirkeycode & ~stim.av.congseq & ~stim.av.vtrialseq))  /length(find(trialuse & ~stim.av.congseq & ~stim.av.vtrialseq))];
      motdir_certuncertN(1,:)=[length(find(resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.congseq & stim.av.vtrialseq))  /length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.congseq & stim.av.vtrialseq))   length(find(resp.cormotdir(:,1)'==resp.motdirkeycode & ~stim.av.congseq & stim.av.vtrialseq))  /length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & ~stim.av.congseq & stim.av.vtrialseq))  length(find(resp.cormotdir(:,1)'==resp.motdirkeycode & ~stim.av.congseq & ~stim.av.vtrialseq))  /length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & ~stim.av.congseq & ~stim.av.vtrialseq))];
      motdir_certuncertN(2,:)=[length(find(resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.congseq & stim.av.vtrialseq))  /length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.congseq & stim.av.vtrialseq))   length(find(resp.cormotdir(:,2)'==resp.motdirkeycode & ~stim.av.congseq & stim.av.vtrialseq))  /length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & ~stim.av.congseq & stim.av.vtrialseq))  length(find(resp.cormotdir(:,2)'==resp.motdirkeycode & ~stim.av.congseq & ~stim.av.vtrialseq))  /length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & ~stim.av.congseq & ~stim.av.vtrialseq))];
      motdir_certuncert
%       motdir_certuncertN
    else
    ...
    for aa=1:length(unique(stim.isiseq))
      for bb=1:length(unique(stim.durseq))
        try
          if isfield(setup,'respcertMD') && setup.respcertMD==1
            percorout=nan; % not bother to compute these
            percoroutnum=nan;
          else
    ...
    if isfield(setup,'respcertMD') && setup.respcertMD==1
      ...
      if length(unique(stim.isiseq))>1 || length(unique(stim.durseq))>1
    ...
    if setup.av.askfmdcs==1 || setup.av.askfmdcs==2
      ...
      if isfield(setup,'respcertCS') && setup.respcertCS==1
        comsrc=[length(find(sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & stim.av.vtrialseq))  /length(find(trialuse & stim.av.congseq & stim.av.vtrialseq))   length(find(sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq  & stim.av.vtrialseq))  /length(find(trialuse& ~stim.av.congseq & stim.av.vtrialseq))    ];
        comsrc_certuncert(1,:)=[length(find(resp.comsrckeycode==resp.corcong(:,1)' & stim.av.congseq & stim.av.vtrialseq))  /length(find(trialuse & stim.av.congseq & stim.av.vtrialseq))   length(find(resp.comsrckeycode==resp.corcong(:,1)' & ~stim.av.congseq  & stim.av.vtrialseq))  /length(find(trialuse& ~stim.av.congseq & stim.av.vtrialseq))    ];
        comsrc_certuncert(2,:)=[length(find(resp.comsrckeycode==resp.corcong(:,2)' & stim.av.congseq & stim.av.vtrialseq))  /length(find(trialuse & stim.av.congseq & stim.av.vtrialseq))   length(find(resp.comsrckeycode==resp.corcong(:,2)' & ~stim.av.congseq  & stim.av.vtrialseq))  /length(find(trialuse& ~stim.av.congseq & stim.av.vtrialseq))    ];
      else
      ...
      for aa=1:length(unique(stim.isiseq))
        for bb=1:length(unique(stim.durseq))
          if isfield(setup,'respcertCS') && setup.respcertCS==1
            comsrcMDisidur(aa,:,bb)=[length(find(sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & stim.av.congseq & sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & ~sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & stim.av.congseq & ~sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq  & sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse& ~stim.av.congseq & sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))      length(find(sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq  & ~sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse& ~stim.av.congseq & ~sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))];
            comsrcMDisidur_numer(aa,:,bb)=[length(find(sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & ~sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq  & sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))       length(find(sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq  & ~sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb)) ];
            comsrcMDisidur_denom(aa,:,bb)=[length(find(trialuse & stim.av.congseq & sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(trialuse & stim.av.congseq & ~sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(trialuse& ~stim.av.congseq & sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))      length(find(trialuse& ~stim.av.congseq & ~sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))];
            
            % for separate cert and uncert
            comsrcMDisidur_cuCS(aa,:,bb,1)=[length(find(resp.comsrckeycode==resp.corcong(:,1)' & stim.av.congseq & sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & stim.av.congseq & sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(resp.comsrckeycode==resp.corcong(:,1)' & stim.av.congseq & ~sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & stim.av.congseq & ~sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(resp.comsrckeycode==resp.corcong(:,1)' & ~stim.av.congseq  & sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse& ~stim.av.congseq & sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))      length(find(resp.comsrckeycode==resp.corcong(:,1)' & ~stim.av.congseq  & ~sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse& ~stim.av.congseq & ~sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))];
            comsrcMDisidur_cuCS(aa,:,bb,2)=[length(find(resp.comsrckeycode==resp.corcong(:,2)' & stim.av.congseq & sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & stim.av.congseq & sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(resp.comsrckeycode==resp.corcong(:,2)' & stim.av.congseq & ~sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & stim.av.congseq & ~sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(resp.comsrckeycode==resp.corcong(:,2)' & ~stim.av.congseq  & sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse& ~stim.av.congseq & sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))      length(find(resp.comsrckeycode==resp.corcong(:,2)' & ~stim.av.congseq  & ~sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse& ~stim.av.congseq & ~sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))];
            comsrcMDisidur_cuMD(aa,:,bb,1)=[length(find(sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & stim.av.congseq & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq  & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse& ~stim.av.congseq & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))      length(find(sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq  & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse& ~stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))];
            comsrcMDisidur_cuMD(aa,:,bb,2)=[length(find(sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & stim.av.congseq & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq  & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse& ~stim.av.congseq & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))      length(find(sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq  & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse& ~stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))];
            comsrcMDisidur_cuCS_cuMD(aa,:,bb,1,1)=[length(find(resp.comsrckeycode==resp.corcong(:,1)' & stim.av.congseq & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & stim.av.congseq & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(resp.comsrckeycode==resp.corcong(:,1)' & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(resp.comsrckeycode==resp.corcong(:,1)' & ~stim.av.congseq  & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse& ~stim.av.congseq & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))      length(find(resp.comsrckeycode==resp.corcong(:,1)' & ~stim.av.congseq  & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse& ~stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))];
            comsrcMDisidur_cuCS_cuMD(aa,:,bb,1,2)=[length(find(resp.comsrckeycode==resp.corcong(:,1)' & stim.av.congseq & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & stim.av.congseq & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(resp.comsrckeycode==resp.corcong(:,1)' & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(resp.comsrckeycode==resp.corcong(:,1)' & ~stim.av.congseq  & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse& ~stim.av.congseq & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))      length(find(resp.comsrckeycode==resp.corcong(:,1)' & ~stim.av.congseq  & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse& ~stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))];
            comsrcMDisidur_cuCS_cuMD(aa,:,bb,2,1)=[length(find(resp.comsrckeycode==resp.corcong(:,2)' & stim.av.congseq & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & stim.av.congseq & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(resp.comsrckeycode==resp.corcong(:,2)' & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(resp.comsrckeycode==resp.corcong(:,2)' & ~stim.av.congseq  & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse& ~stim.av.congseq & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))      length(find(resp.comsrckeycode==resp.corcong(:,2)' & ~stim.av.congseq  & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse& ~stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))];
            comsrcMDisidur_cuCS_cuMD(aa,:,bb,2,2)=[length(find(resp.comsrckeycode==resp.corcong(:,2)' & stim.av.congseq & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & stim.av.congseq & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(resp.comsrckeycode==resp.corcong(:,2)' & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(resp.comsrckeycode==resp.corcong(:,2)' & ~stim.av.congseq  & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse& ~stim.av.congseq & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))      length(find(resp.comsrckeycode==resp.corcong(:,2)' & ~stim.av.congseq  & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse& ~stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))];
            
            comsrcMDisidur_cuCS_cuMD_numer(aa,:,bb,1,1)=[length(find(resp.comsrckeycode==resp.corcong(:,1)' & stim.av.congseq & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(resp.comsrckeycode==resp.corcong(:,1)' & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(resp.comsrckeycode==resp.corcong(:,1)' & ~stim.av.congseq  & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))      length(find(resp.comsrckeycode==resp.corcong(:,1)' & ~stim.av.congseq  & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb)) ];
            comsrcMDisidur_cuCS_cuMD_numer(aa,:,bb,1,2)=[length(find(resp.comsrckeycode==resp.corcong(:,1)' & stim.av.congseq & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(resp.comsrckeycode==resp.corcong(:,1)' & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(resp.comsrckeycode==resp.corcong(:,1)' & ~stim.av.congseq  & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))      length(find(resp.comsrckeycode==resp.corcong(:,1)' & ~stim.av.congseq  & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb)) ];
            comsrcMDisidur_cuCS_cuMD_numer(aa,:,bb,2,1)=[length(find(resp.comsrckeycode==resp.corcong(:,2)' & stim.av.congseq & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(resp.comsrckeycode==resp.corcong(:,2)' & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(resp.comsrckeycode==resp.corcong(:,2)' & ~stim.av.congseq  & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))      length(find(resp.comsrckeycode==resp.corcong(:,2)' & ~stim.av.congseq  & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb)) ];
            comsrcMDisidur_cuCS_cuMD_numer(aa,:,bb,2,2)=[length(find(resp.comsrckeycode==resp.corcong(:,2)' & stim.av.congseq & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(resp.comsrckeycode==resp.corcong(:,2)' & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(resp.comsrckeycode==resp.corcong(:,2)' & ~stim.av.congseq  & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))      length(find(resp.comsrckeycode==resp.corcong(:,2)' & ~stim.av.congseq  & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb)) ];
            comsrcMDisidur_cuCS_cuMD_denom(aa,:,bb,1,1)=[length(find(trialuse & stim.av.congseq & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  length(find(trialuse & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(trialuse& ~stim.av.congseq & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(trialuse& ~stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))];
            comsrcMDisidur_cuCS_cuMD_denom(aa,:,bb,1,2)=[length(find(trialuse & stim.av.congseq & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  length(find(trialuse & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(trialuse& ~stim.av.congseq & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(trialuse& ~stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))];
            comsrcMDisidur_cuCS_cuMD_denom(aa,:,bb,2,1)=[length(find(trialuse & stim.av.congseq & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  length(find(trialuse & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(trialuse& ~stim.av.congseq & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(trialuse& ~stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))];
            comsrcMDisidur_cuCS_cuMD_denom(aa,:,bb,2,2)=[length(find(trialuse & stim.av.congseq & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  length(find(trialuse & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(trialuse& ~stim.av.congseq & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(trialuse& ~stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))];
          else
      ...
      comsrcMDisidur
%       if isfield(setup,'respcertCS') && setup.respcertCS==1
%         disp('cert/uncert on CS (all MD)')
%         squeeze(comsrcMDisidur_cuCS(1,:,1,:))'
%         disp('cert/uncert on MD (all CS)')
%         squeeze(comsrcMDisidur_cuMD(1,:,1,:))'
%         disp('certain on MD; cert/uncert for CS')
%         squeeze(comsrcMDisidur_cuCS_cuMD(1,:,1,:,1))'
%         disp('uncert on MD; cert/uncert for CS')
%         squeeze(comsrcMDisidur_cuCS_cuMD(1,:,1,:,2))'
%         %         disp('certain on MD; cert/uncert for CS:  numerator')
%         %         squeeze(comsrcMDisidur_cuCS_cuMD_numer(1,:,1,:,1))'
%         %         disp('uncert on MD; cert/uncert for CS:   numerator')
%         %         squeeze(comsrcMDisidur_cuCS_cuMD_numer(1,:,1,:,2))'
%         %         disp('certain on MD; cert/uncert for CS:  denominator')
%         %         squeeze(comsrcMDisidur_cuCS_cuMD_denom(1,:,1,:,1))'
%         %         disp('uncert on MD; cert/uncert for CS:   denominator')
%         %         squeeze(comsrcMDisidur_cuCS_cuMD_denom(1,:,1,:,2))'
%       end
      
      
      if [isfield(setup,'respcertCS') && setup.respcertCS==1] || [isfield(setup,'respcertMD') && setup.respcertMD==1]
      else
        %     if length(unique(stim.durseq))>1 && length(unique(stim.isiseq))>1
        for aa=1:length(unique(stim.isiseq))
          for bb=1:length(unique(stim.durseq))
      ...
      if [isfield(setup,'respcertCS') && setup.respcertCS==1] || [isfield(setup,'respcertMD') && setup.respcertMD==1]
        ...
        disp('ComSrcCorr, ComSrcIncor (percent correct of motion direction) (columns), per each ISI (rows) and Duration (3rd dimension)')
      ...
      for aa=1:length(unique(stim.isiseq))
        for bb=1:length(unique(stim.durseq))
          try
            if [isfield(setup,'respcertCS') && setup.respcertCS==1] && [isfield(setup,'respcertMD') && setup.respcertMD==1]
              percorcomsrccong(aa,:,bb)=[length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & ~sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & ~sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & ~sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & ~sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb)) ];
              percorcomsrccong_numer(aa,:,bb)=[length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))      length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & ~sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))      length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & ~sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  ];
              percorcomsrccong_denom(aa,:,bb)=[length(find(trialuse & sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))   length(find(trialuse & sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(trialuse & ~sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(trialuse & ~sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb)) ];

              percorcomsrccong_cuMD(aa,:,bb,1)=[length(find(resp.cormotdir(:,1)'==resp.motdirkeycode & sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(resp.cormotdir(:,1)'==resp.motdirkeycode & sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(resp.cormotdir(:,1)'==resp.motdirkeycode & ~sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & ~sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(resp.cormotdir(:,1)'==resp.motdirkeycode & ~sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & ~sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb)) ];
              percorcomsrccong_cuMD(aa,:,bb,2)=[length(find(resp.cormotdir(:,2)'==resp.motdirkeycode & sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(resp.cormotdir(:,2)'==resp.motdirkeycode & sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(resp.cormotdir(:,2)'==resp.motdirkeycode & ~sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & ~sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(resp.cormotdir(:,2)'==resp.motdirkeycode & ~sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & ~sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb)) ];
              
              percorcomsrccong_cuCS(aa,:,bb,1)=[length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & resp.comsrckeycode==resp.corcong(:,1)' & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & resp.comsrckeycode==resp.corcong(:,1)' & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & resp.comsrckeycode==resp.corcong(:,1)' & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & resp.comsrckeycode==resp.corcong(:,1)' & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & [resp.comsrckeycode==resp.corcong(1) | resp.comsrckeycode==resp.corcong(4)] & resp.comsrckeycode~=resp.corcong(:,1)' & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & [resp.comsrckeycode==resp.corcong(1) | resp.comsrckeycode==resp.corcong(4)] & resp.comsrckeycode~=resp.corcong(:,1)' & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & [resp.comsrckeycode==resp.corcong(1) | resp.comsrckeycode==resp.corcong(4)] & resp.comsrckeycode~=resp.corcong(:,1)' & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & [resp.comsrckeycode==resp.corcong(1) | resp.comsrckeycode==resp.corcong(4)] & resp.comsrckeycode~=resp.corcong(:,1)' & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb)) ];
              percorcomsrccong_cuCS(aa,:,bb,2)=[length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & resp.comsrckeycode==resp.corcong(:,2)' & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & resp.comsrckeycode==resp.corcong(:,2)' & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & resp.comsrckeycode==resp.corcong(:,2)' & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & resp.comsrckeycode==resp.corcong(:,2)' & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & [resp.comsrckeycode==resp.corcong(2) | resp.comsrckeycode==resp.corcong(3)] & resp.comsrckeycode~=resp.corcong(:,2)' & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & [resp.comsrckeycode==resp.corcong(2) | resp.comsrckeycode==resp.corcong(3)] & resp.comsrckeycode~=resp.corcong(:,2)' & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & [resp.comsrckeycode==resp.corcong(2) | resp.comsrckeycode==resp.corcong(3)] & resp.comsrckeycode~=resp.corcong(:,2)' & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & [resp.comsrckeycode==resp.corcong(2) | resp.comsrckeycode==resp.corcong(3)] & resp.comsrckeycode~=resp.corcong(:,2)' & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb)) ];
              
              percorcomsrccong_cuMD_cuCS(aa,:,bb,1,1)=[length(find(resp.cormotdir(:,1)'==resp.motdirkeycode & resp.comsrckeycode==resp.corcong(:,1)' & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & resp.comsrckeycode==resp.corcong(:,1)' & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(resp.cormotdir(:,1)'==resp.motdirkeycode & resp.comsrckeycode==resp.corcong(:,1)' & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & resp.comsrckeycode==resp.corcong(:,1)' & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(resp.cormotdir(:,1)'==resp.motdirkeycode & [resp.comsrckeycode==resp.corcong(1) | resp.comsrckeycode==resp.corcong(4)] & resp.comsrckeycode~=resp.corcong(:,1)' & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & [resp.comsrckeycode==resp.corcong(1) | resp.comsrckeycode==resp.corcong(4)] & resp.comsrckeycode~=resp.corcong(:,1)' & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(resp.cormotdir(:,1)'==resp.motdirkeycode & [resp.comsrckeycode==resp.corcong(1) | resp.comsrckeycode==resp.corcong(4)] & resp.comsrckeycode~=resp.corcong(:,1)' & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & [resp.comsrckeycode==resp.corcong(1) | resp.comsrckeycode==resp.corcong(4)] & resp.comsrckeycode~=resp.corcong(:,1)' & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb)) ];
              percorcomsrccong_cuMD_cuCS(aa,:,bb,1,2)=[length(find(resp.cormotdir(:,1)'==resp.motdirkeycode & resp.comsrckeycode==resp.corcong(:,2)' & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & resp.comsrckeycode==resp.corcong(:,2)' & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(resp.cormotdir(:,1)'==resp.motdirkeycode & resp.comsrckeycode==resp.corcong(:,2)' & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & resp.comsrckeycode==resp.corcong(:,2)' & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(resp.cormotdir(:,1)'==resp.motdirkeycode & [resp.comsrckeycode==resp.corcong(2) | resp.comsrckeycode==resp.corcong(3)] & resp.comsrckeycode~=resp.corcong(:,2)' & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & [resp.comsrckeycode==resp.corcong(2) | resp.comsrckeycode==resp.corcong(3)] & resp.comsrckeycode~=resp.corcong(:,2)' & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(resp.cormotdir(:,1)'==resp.motdirkeycode & [resp.comsrckeycode==resp.corcong(2) | resp.comsrckeycode==resp.corcong(3)] & resp.comsrckeycode~=resp.corcong(:,2)' & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & [resp.comsrckeycode==resp.corcong(2) | resp.comsrckeycode==resp.corcong(3)] & resp.comsrckeycode~=resp.corcong(:,2)' & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb)) ];
              percorcomsrccong_cuMD_cuCS(aa,:,bb,2,1)=[length(find(resp.cormotdir(:,2)'==resp.motdirkeycode & resp.comsrckeycode==resp.corcong(:,1)' & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & resp.comsrckeycode==resp.corcong(:,1)' & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(resp.cormotdir(:,2)'==resp.motdirkeycode & resp.comsrckeycode==resp.corcong(:,1)' & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & resp.comsrckeycode==resp.corcong(:,1)' & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(resp.cormotdir(:,2)'==resp.motdirkeycode & [resp.comsrckeycode==resp.corcong(1) | resp.comsrckeycode==resp.corcong(4)] & resp.comsrckeycode~=resp.corcong(:,1)' & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & [resp.comsrckeycode==resp.corcong(1) | resp.comsrckeycode==resp.corcong(4)] & resp.comsrckeycode~=resp.corcong(:,1)' & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(resp.cormotdir(:,2)'==resp.motdirkeycode & [resp.comsrckeycode==resp.corcong(1) | resp.comsrckeycode==resp.corcong(4)] & resp.comsrckeycode~=resp.corcong(:,1)' & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & [resp.comsrckeycode==resp.corcong(1) | resp.comsrckeycode==resp.corcong(4)] & resp.comsrckeycode~=resp.corcong(:,1)' & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb)) ];
              percorcomsrccong_cuMD_cuCS(aa,:,bb,2,2)=[length(find(resp.cormotdir(:,2)'==resp.motdirkeycode & resp.comsrckeycode==resp.corcong(:,2)' & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & resp.comsrckeycode==resp.corcong(:,2)' & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))    length(find(resp.cormotdir(:,2)'==resp.motdirkeycode & resp.comsrckeycode==resp.corcong(:,2)' & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & resp.comsrckeycode==resp.corcong(:,2)' & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(resp.cormotdir(:,2)'==resp.motdirkeycode & [resp.comsrckeycode==resp.corcong(2) | resp.comsrckeycode==resp.corcong(3)] & resp.comsrckeycode~=resp.corcong(:,2)' & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & [resp.comsrckeycode==resp.corcong(2) | resp.comsrckeycode==resp.corcong(3)] & resp.comsrckeycode~=resp.corcong(:,2)' & stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))     length(find(resp.cormotdir(:,2)'==resp.motdirkeycode & [resp.comsrckeycode==resp.corcong(2) | resp.comsrckeycode==resp.corcong(3)] & resp.comsrckeycode~=resp.corcong(:,2)' & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb))  /length(find(trialuse & [resp.comsrckeycode==resp.corcong(2) | resp.comsrckeycode==resp.corcong(3)] & resp.comsrckeycode~=resp.corcong(:,2)' & ~stim.av.congseq & stim.av.vtrialseq & stim.isiseq==aa & stim.durseq==bb)) ];
    ...
    switch setup.paradigm
      case 'cued'
        ...
        for cc=unique(stim.av.cueseq)
          if isfield(setup,'respcertMD') && setup.respcertMD==1
            [length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))   length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))    length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & ~stim.av.congseq & ~stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & ~stim.av.congseq & ~stim.av.vtrialseq & stim.av.cueseq==cc))]
          else
        ...
        try
          for cc=unique(stim.av.cueseq)
            if isfield(setup,'respcertMD') && setup.respcertMD==1
              percorcomsrccong_percue(cc,:)=[length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))    length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))     length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & ~sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & ~sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))     length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & ~sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & ~sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc)) ];
              percorcomsrccong_percue_numer(cc,:)=[length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))    length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))     length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & ~sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))      length(find(sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & ~sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))];
              percorcomsrccong_percue_denom(cc,:)=[length(find(trialuse & sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))   length(find(trialuse & sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))     length(find(trialuse & ~sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))    length(find(trialuse & ~sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc)) ];

              percorcomsrccong_percue_cuMD_cuCS(cc,:,1,1)=[length(find(resp.cormotdir(:,1)'==resp.motdirkeycode & resp.comsrckeycode==resp.corcong(:,1)' & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & resp.comsrckeycode==resp.corcong(:,1)' & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))    length(find(resp.cormotdir(:,1)'==resp.motdirkeycode & resp.comsrckeycode==resp.corcong(:,1)' & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & resp.comsrckeycode==resp.corcong(:,1)' & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))     length(find(resp.cormotdir(:,1)'==resp.motdirkeycode & [resp.comsrckeycode==resp.corcong(1) | resp.comsrckeycode==resp.corcong(4)] & ~(resp.comsrckeycode==resp.corcong(:,1)') & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & [resp.comsrckeycode==resp.corcong(1) | resp.comsrckeycode==resp.corcong(4)] & ~(resp.comsrckeycode==resp.corcong(:,1)') & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))     length(find(resp.cormotdir(:,1)'==resp.motdirkeycode & [resp.comsrckeycode==resp.corcong(1) | resp.comsrckeycode==resp.corcong(4)] & ~(resp.comsrckeycode==resp.corcong(:,1)') & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & [resp.comsrckeycode==resp.corcong(1) | resp.comsrckeycode==resp.corcong(4)] & ~(resp.comsrckeycode==resp.corcong(:,1)') & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc)) ];
              percorcomsrccong_percue_cuMD_cuCS(cc,:,1,2)=[length(find(resp.cormotdir(:,1)'==resp.motdirkeycode & resp.comsrckeycode==resp.corcong(:,2)' & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & resp.comsrckeycode==resp.corcong(:,2)' & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))    length(find(resp.cormotdir(:,1)'==resp.motdirkeycode & resp.comsrckeycode==resp.corcong(:,2)' & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & resp.comsrckeycode==resp.corcong(:,2)' & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))     length(find(resp.cormotdir(:,1)'==resp.motdirkeycode & [resp.comsrckeycode==resp.corcong(2) | resp.comsrckeycode==resp.corcong(3)] & ~(resp.comsrckeycode==resp.corcong(:,2)') & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & [resp.comsrckeycode==resp.corcong(2) | resp.comsrckeycode==resp.corcong(3)] & ~(resp.comsrckeycode==resp.corcong(:,2)') & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))     length(find(resp.cormotdir(:,1)'==resp.motdirkeycode & [resp.comsrckeycode==resp.corcong(2) | resp.comsrckeycode==resp.corcong(3)] & ~(resp.comsrckeycode==resp.corcong(:,2)') & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & [resp.comsrckeycode==resp.corcong(2) | resp.comsrckeycode==resp.corcong(3)] & ~(resp.comsrckeycode==resp.corcong(:,2)') & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc)) ];
              percorcomsrccong_percue_cuMD_cuCS(cc,:,2,1)=[length(find(resp.cormotdir(:,2)'==resp.motdirkeycode & resp.comsrckeycode==resp.corcong(:,1)' & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & resp.comsrckeycode==resp.corcong(:,1)' & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))    length(find(resp.cormotdir(:,2)'==resp.motdirkeycode & resp.comsrckeycode==resp.corcong(:,1)' & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & resp.comsrckeycode==resp.corcong(:,1)' & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))     length(find(resp.cormotdir(:,2)'==resp.motdirkeycode & [resp.comsrckeycode==resp.corcong(1) | resp.comsrckeycode==resp.corcong(4)] & ~(resp.comsrckeycode==resp.corcong(:,1)') & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & [resp.comsrckeycode==resp.corcong(1) | resp.comsrckeycode==resp.corcong(4)] & ~(resp.comsrckeycode==resp.corcong(:,1)') & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))     length(find(resp.cormotdir(:,2)'==resp.motdirkeycode & [resp.comsrckeycode==resp.corcong(1) | resp.comsrckeycode==resp.corcong(4)] & ~(resp.comsrckeycode==resp.corcong(:,1)') & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & [resp.comsrckeycode==resp.corcong(1) | resp.comsrckeycode==resp.corcong(4)] & ~(resp.comsrckeycode==resp.corcong(:,1)') & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc)) ];
              percorcomsrccong_percue_cuMD_cuCS(cc,:,2,2)=[length(find(resp.cormotdir(:,2)'==resp.motdirkeycode & resp.comsrckeycode==resp.corcong(:,2)' & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & resp.comsrckeycode==resp.corcong(:,2)' & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))    length(find(resp.cormotdir(:,2)'==resp.motdirkeycode & resp.comsrckeycode==resp.corcong(:,2)' & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & resp.comsrckeycode==resp.corcong(:,2)' & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))     length(find(resp.cormotdir(:,2)'==resp.motdirkeycode & [resp.comsrckeycode==resp.corcong(2) | resp.comsrckeycode==resp.corcong(3)] & ~(resp.comsrckeycode==resp.corcong(:,2)') & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & [resp.comsrckeycode==resp.corcong(2) | resp.comsrckeycode==resp.corcong(3)] & ~(resp.comsrckeycode==resp.corcong(:,2)') & stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))     length(find(resp.cormotdir(:,2)'==resp.motdirkeycode & [resp.comsrckeycode==resp.corcong(2) | resp.comsrckeycode==resp.corcong(3)] & ~(resp.comsrckeycode==resp.corcong(:,2)') & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & [resp.comsrckeycode==resp.corcong(2) | resp.comsrckeycode==resp.corcong(3)] & ~(resp.comsrckeycode==resp.corcong(:,2)') & ~stim.av.congseq & stim.av.vtrialseq & stim.av.cueseq==cc)) ];
            else
        ...
        try
          for cc=unique(stim.av.cueseq)
            if isfield(setup,'respcertMD') && setup.respcertMD==1
              comsrcMDisidur_percue(cc,:)=[length(find(sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & stim.av.congseq & sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.av.cueseq==cc))   length(find(sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & ~sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & stim.av.congseq & ~sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.av.cueseq==cc))    length(find(sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq  & sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse& ~stim.av.congseq & sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.av.cueseq==cc))      length(find(sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq  & ~sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse& ~stim.av.congseq & ~sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.av.cueseq==cc))];
              comsrcMDisidur_percue_numer(cc,:)=[length(find(sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.av.cueseq==cc))    length(find(sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & stim.av.congseq & ~sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.av.cueseq==cc))    length(find(sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq  & sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.av.cueseq==cc))        length(find(sum(repmat(resp.comsrckeycode,[2 1])==resp.corcong',1) & ~stim.av.congseq  & ~sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.av.cueseq==cc))  ];
              comsrcMDisidur_percue_denom(cc,:)=[length(find(trialuse & stim.av.congseq & sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.av.cueseq==cc))   length(find(trialuse & stim.av.congseq & ~sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.av.cueseq==cc))   length(find(trialuse& ~stim.av.congseq & sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.av.cueseq==cc))    length(find(trialuse& ~stim.av.congseq & ~sum(resp.cormotdir'==repmat(resp.motdirkeycode,[2 1]),1) & stim.av.vtrialseq & stim.av.cueseq==cc))];

              comsrcMDisidur_percue_cuCS_cuMD(cc,:,1,1)=[length(find(resp.comsrckeycode==resp.corcong(:,1)' & stim.av.congseq & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & stim.av.congseq & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))   length(find(resp.comsrckeycode==resp.corcong(:,1)' & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))    length(find(resp.comsrckeycode==resp.corcong(:,1)' & ~stim.av.congseq  & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse& ~stim.av.congseq & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))      length(find(resp.comsrckeycode==resp.corcong(:,1)' & ~stim.av.congseq  & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse& ~stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))];
              comsrcMDisidur_percue_cuCS_cuMD(cc,:,1,2)=[length(find(resp.comsrckeycode==resp.corcong(:,1)' & stim.av.congseq & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & stim.av.congseq & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))   length(find(resp.comsrckeycode==resp.corcong(:,1)' & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))    length(find(resp.comsrckeycode==resp.corcong(:,1)' & ~stim.av.congseq  & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse& ~stim.av.congseq & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))      length(find(resp.comsrckeycode==resp.corcong(:,1)' & ~stim.av.congseq  & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse& ~stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))];
              comsrcMDisidur_percue_cuCS_cuMD(cc,:,2,1)=[length(find(resp.comsrckeycode==resp.corcong(:,2)' & stim.av.congseq & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & stim.av.congseq & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))   length(find(resp.comsrckeycode==resp.corcong(:,2)' & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))    length(find(resp.comsrckeycode==resp.corcong(:,2)' & ~stim.av.congseq  & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse& ~stim.av.congseq & resp.cormotdir(:,1)'==resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))      length(find(resp.comsrckeycode==resp.corcong(:,2)' & ~stim.av.congseq  & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse& ~stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(1) | resp.motdirkeycode==resp.motdirkey(4)] & resp.cormotdir(:,1)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))];
              comsrcMDisidur_percue_cuCS_cuMD(cc,:,2,2)=[length(find(resp.comsrckeycode==resp.corcong(:,2)' & stim.av.congseq & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & stim.av.congseq & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))   length(find(resp.comsrckeycode==resp.corcong(:,2)' & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse & stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))    length(find(resp.comsrckeycode==resp.corcong(:,2)' & ~stim.av.congseq  & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse& ~stim.av.congseq & resp.cormotdir(:,2)'==resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))      length(find(resp.comsrckeycode==resp.corcong(:,2)' & ~stim.av.congseq  & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))  /length(find(trialuse& ~stim.av.congseq & [resp.motdirkeycode==resp.motdirkey(2) | resp.motdirkeycode==resp.motdirkey(3)] & resp.cormotdir(:,2)'~=resp.motdirkeycode & stim.av.vtrialseq & stim.av.cueseq==cc))];
            else
